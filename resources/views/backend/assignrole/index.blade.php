        ...
        <div class="page-color">
            ...
            <div class="page-header">
                <div class="page-title">
                    ...
                    <select class="cus-menu" name="select_session" id="select_session">
                        ...
                        <div class="page-btn">
                            <a href="javascript:void(0)" class="btn custom-btn addUser">Add User</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="page-body">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="close" data-dismiss="modal"><svg width="24" height="24"
                                            ...
                                            <path d="M18 6L6 18" stroke="#CCD2E3" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M6 6L18 18" stroke="#CCD2E3" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg></button>
                                </div>
                                @error('password')
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('storerole') }}" method="POST" class="" id="storeuserrole">
                                        @csrf
                                        <div class="form-group">
                                            <label> User Name</label>
                                            <input type="text" placeholder="Enter username" name="name" id="u_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('user_type') is-invalid @enderror" required name="user_type" id="user_type">
                                ...
                                <div class="modal-footer justify-content-center">
                                    <div class=" text-center">
                                        <button type="submit" name="save" class="btn custom-btn" id="save">Create
                                            User</button>
                                    </div>
                                    </form>
                                </div>
                ...
                <div class="page-table" id="">
                    <table id="examplea" class="tabel-res custom-table dataTable" style="width:100%;">
                        ...
                        <tbody id="result">
                            ...
                            <tr>
                                ...
                                <td class="students-name">{{ $user->name }}</td>
                                <td class="sorting_1"><label
                                        class="custom-badge  badge badge-primary">{{ $user->user_type }}</label></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="tool">
                                            <a data-toggle="tooltip" data-placement="top" data-original-title="Edit"
                                                class=" tool btn-sml editrole"
                                                data-href="{{ route('assignrole.edit',$user->id) }}"
                                                data-id="{{$user->id}}">
                                                <svg class="nofill" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <mask id="path-1-outside-1_1154_12363" maskUnits="userSpaceOnUse"
                                                        x="3" y="4" width="17" height="17" fill="black">
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#8F99B3" mask="url(#path-1-outside-1_1154_12363)"></path>
                                        ...
                                        <span class="tool">
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" data-original-title="Delete"
                                                ...
                                                class="btn-sml delete-btn deleterole"
                                                data-name="{{ $user->name }}" data-id="{{$user->id}}"> <svg
                    ...
                    <div id="RoleDeleteModal" class="modal modal-danger fade" tabindex="-1" role="dialog"
                                ...
                                <form action="{{url('roledelete')}}" method="POST" class="remove-record-model">
                                    ...
                                    <div class="modal-body">
                                        <span class="alert alert-danger w-100 alert-delete">
                                            ...
                                            You want you sure delete
                                        <span id="userrolename"></span>?</span>
                ...
                <div class="modal fade" id="myAssignEModal" role="dialog">
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ url('editrole') }}" method="POST" class="" id="updateuserrole">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label> User Name</label>
                                        <input type="text" placeholder="Enter Name" name="name" id="uname" class="form-control">

                                    </div>
                                    <div class="form-group">
                                        <label>Assign Role</label>
                                        <select class="form-control" name="user_type" id="uuser_type">
                                            <option value="Accountant">Accountant</option>
                                            <option value="Admin">Admin</option>
                                            <option value="Manager">Manager</option>
                                            <option value="Teacher">Teacher</option>
                            ...
                            <div class="modal-footer justify-content-center">
                                <div class="text-center">
                                    <input type="submit" name="save" class="btn custom-btn" value="Update Role">
                                </div>
                            </div>
                            </form>
