...
<div class="page-inner ad-inr">
    ...
    <section class="main-wrapper">
        <div class="page-color">
            ...
            <div class="page-body">
                        ...
                        <form action="{{ route('import') }}" method="Post" enctype="multipart/form-data"
                            ...
                            <div class="btn-group">
                                <div class="btn-single">
                                    <a data-toggle="tooltip" data-placement="top" data-original-title="Import CSV"
                                        href="javascript:void(0)" class="btn import btn-data" role='button'>
                                ...
                                <div data-toggle="tooltip" data-placement="top" data-original-title="Download CSV"
                                    class="btn-single"> <a href="javascript:void(0)" id="export" class="btn  btn-data"
                                        role='button'>
                ...
                <form id="frm-example" action="javascript:void(0)" method="get">
                    <div class="page-table" id="dvData">
                        <table id="" class="studenttable tabel-res display nowrap" style="width:100%;"
                            data-plugin-options='{"searchPlaceholder": "Suchen"}'>
                            <thead>
                                <tr>
                            ...
                            <tbody id="result">
                                ...
                                <tr>
                                    ...
                                    <td class="width-50"><span
                                            class="custom-badge badge badge-primary">{{$student->student_id}}</span>
                                    </td>
                                    ...
                                    <td>
                                        <ul class="d-flex">
                                            <li class="tool tool-view">
                                                <a data-toggle="tooltip" data-placement="top" data-original-title="Fees"
                                                    class="fees-popup btn-sml" data-id="{{$student->id}}"
                                                    data-href="{{route('students.edit',$student->id)}}"
                                                    fees-href="{{url('show',['student'=>$student->id,'session'=>$r->session])}}">
                                            ...
                                            <li class="tool tool-view">
                                                <a data-toggle="tooltip" data-placement="top" data-original-title="Edit"
                                                    class="studentpopup btn-sml" data-id="{{$student->id}}"
                                                    data-href="{{route('students.edit',$student->id)}}"
                                                    fees-href="{{url('show',['student'=>$student->id,'session'=>$r->session])}}">
                                            ...
                                            <li class="tool tool-delete">
                                                ...
                                                <a data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    class="deletestudent btn-sml" data-id="{{$student->id}}"
                                                    data-stdname="{{ Str::title($student->name)}}"
                                                    data-name="{{$r->id}}">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="promote-student">
                        <button type="submit" class="btn custom-btn add-btn" data-toggle="modal"
                            data-target="#promoteModal">Promote Student</button>
                    </div>
                    @endif
                    <div class="container">
                ...
                <div id="studentDeleteModal" class="modal modal-danger fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-footer">
                                    <div class="col-md-12 text-center">
                                        <div class="btn-box">
                                            ...
                                            <button type="submit" class="btn custom-btn btn-danger delete-data-btn waves-effect remove-data-from-delete-form add-btn"
                                                >Delete</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form method="Post" action="{{url('editstudent')}}" enctype="multipart/form-data"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="student_id"
                                                            id="student_ids" value="" placeholder="Student Id">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="scholar_nos">Student No.</label>
                                                        <input class="form-control" type="text" name="scholar_no"
                                                            id="scholar_nos" value="" placeholder="Scholar No.">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="father_name"
                                                            id="fname" value="" placeholder="Father name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="mother_name"
                                                            id="mname" value="" placeholder="Mother name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="address"
                                                            id="addres" value="" placeholder="Address">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="aadhar">Aadhar No.</label>
                                                        <input class="form-control" type="number" name="aadhar_no"
                                                            id="aadhar" value="" placeholder="Aadhar No.">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="samargid">Samagra Id</label>
                                                        <input class="form-control" type="number" name="samarg_id"
                                                            id="samargid" value="" placeholder="Samagra Id">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group birth-date">
                                                        <label for="sdob">Date of Birth</label>
                                                        <input class="form-control" type="text" name="dob" id="sdob"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="number" name="mobile_no"
                                                            id="m1" value="" placeholder="Mobile No.">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="m2">Telephone No.</label>
                                                        <input class="form-control" type="number" name="mobile_no2"
                                                            id="m2" value="" placeholder="Telephone No.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 last-input-margin">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="number" name="account_no"
                                                            id="acc" value="" placeholder="Bank Account No.">
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-footer">
                                    <div class="col-12 text-center">
                                        <button type="submit" name="save" class="add-btn btn custom-btn"
                                ...
                                <div class="min-height">
                                                ...
                                                <div class="student-wrapper">
                                                    <div class="student-img">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            ...
                                                            <circle cx="12" cy="10" r="3" stroke="#CCD2E3"
                                    ...
                                    <div class="fee-sec detail-head mt-3">
                                        <div class="fee-left">
                                            ...
                                            <h6>Old Dues: ₹ <span class="due-fee badge badge-warning"
                                                    id="old_dues">0</span></h6>
                                        </div>
                                        <div class="fee-right">
                                    ...
                                    <div class="fee-list-head">
                                        ...
                                        <a href="javascript:void(0)"
                                            class="btn custom-btn add-btn deposit-modal">Deposit
                                            Fee</a>
                                    </div>
            ...
            <div class="modal right fade" id="myaddModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content student-modal-content">
                            ...
                            <div class="modal-body after-design">
                                <form action="{{route('students.store')}}" id="studentAdd" method="Post"
                                    ...
                                    <div class="col-md-12 text-center">
                                        <input type="submit" name="save" class="add-btn align-center" id="butsave"
                                            value="Add Student">
                                    </div>
                                </form>
                            </div>
            ...
            <div class="modal right fade" id="feeDepositModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content student-modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="rno" name="receipt_no"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="fe" name="fees"
                                                        placeholder="Amount">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <div class="col-md-12 text-center">
                                <button type="submit" name="save" class="btn custom-btn add-btn align-center"
                                    id="but-save">Add Free</button>
                            </div>
                        </div>
                        </form>
                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="receipt_no"
                                                        id="receipt" placeholder="Receipt No.">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="fee">Amount</label>
                                                    <input class="form-control" type="text" name="fees" id="fee"
                                                        placeholder="Amount">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group birth-date">
                                                    ...
                                                    <input class="form-control" type="text" name="date" id="dates"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="description"
                                                        id="descriptions" placeholder="Received From">
                                                </div>
                                            </div>
                                        </div>
            ...
            <!-- //fees delete -->
            @if(Auth::check() && Auth::user()->user_type == "Admin")
            <div id="reportDeleteModal" class="modal modal-danger fade" tabindex="-1" role="dialog"
                aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-dialog-centered" style="width:55%;">
                    <div class="modal-content">
