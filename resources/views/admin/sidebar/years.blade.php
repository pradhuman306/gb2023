    ...
    <section class="main-wrapper">
        <div class="page-color">
            <div class="page-header">
                <div class="page-title">
                    ...
                    <div class="user-drop-sec">
                        <span class="c_session"><b><img src="{{url('/')}}/assets/image/sess.svg" alt=""></b> {{$y_name}}
                        </span>
                        <ul>
                            <li>
                                <a href="javascript:void(0)"><i>
                                    ...
                                    <span class="drop-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10.831" height="6.197"
                                            viewBox="0 0 10.831 6.197">
                                            <path id="Icon_ionic-ios-arrow-back" data-name="Icon ionic-ios-arrow-back"
                                                d="M13.113,11.6,17.2,7.51a.773.773,0,1,0-1.094-1.091l-4.632,4.629a.771.771,0,0,0-.023,1.065L16.1,16.774a.774.774,0,1,0,1.1-1.09Z"
                                                transform="translate(-6.172 17.445) rotate(-90)" fill="#000" />
                                        </svg>
                                    </span></a>
                                <ul>
                                    <li>
                                        <a href="{{ url('/logout') }}">
                                            <i>
                                                <img src="{{url('/')}}/assets/image/logout-01.svg" class="menu-show"
                                                    alt="">
                                            </i>
                                            <span>Log Out</span>
                                        </a>
            ...
            <div class="page-inr">
                ...
                <table id="" class="studenttable tabel-res  " style="width:100%;">
                        <thead>
                            <tr>
                        ...
                        <tbody id="result">
                            ...
                            <tr>
                                ...
                                <td class="width-160"><b>{{$student->name}}</b><br>
                                    <div class="user-dtls">
                                        <span><img src="{{url('/')}}/assets/image/men.svg"
                                                alt="">{{$student->father_name}}</span>
                                        <span><img src="{{url('/')}}/assets/image/women.svg"
                                                alt="">{{$student->mother_name}}</span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <ul class="d-flex">
                                        <li class="tool tool-view">
                                            <a class="studentpopup" data-id="{{$student->id}}"
                                                data-href="{{route('students.edit',$student->id)}}"
                                                fees-href="{{url('show',['student'=>$student->id,'session'=>$t->session])}}">
                                                <img src="{{url('/')}}/assets/image/feather-eye.svg" width="16px"
                                                    alt=""> </a>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content student-modal-content">
                            <div class="modal-header">
                                <ul>
                                    <li class="active">
                                        <a href="#tabs-2" data-toggle="tab" id="fees-details" role="tab"> Student Fees
                                            Details</a>
                                    </li>
                                    <li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="tabs-1" role="tabpanel">
                                        <form method="Post" action="{{url('editstudent')}}"
                                            enctype="multipart/form-data" id="edit-student">
                                            ...
                                            <div class="min-height">
                                                <div class="row ">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="student_id" id="student_ids"
                                                                value="" placeholder="Student Id">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="scholar_no" id="scholar_nos"
                                                                value="" placeholder="Scholar No.">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group birth-date">
                                                            <input type="text" name="dob" id="sdob" value=""
                                                                placeholder="DOB">
                                            ...
                                            <div class="col-12 text-center">
                                                <input type="submit" name="save" class="add-btn align-center" id="save"
                                                    value="Update">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="tab-pane active" id="tabs-2" role="tabpanel">
                                        <div class="min-height">
                                                ...
                                                <div class="detail-head-inr">
                                                    <div class="head-left">
                                                        ...
                                                        <div class="student-name">
                                                            ...
                                                            <div class="stu-detail">
                                                                <div class="user-dtls">
                                                                    <span class="f_name"><img
                                                                            src="{{url('/')}}/assets/image/men.svg"
                                                                            alt=""></span>
                                                                    <span class="m_name"> <img
                                                                            src="{{url('/')}}/assets/image/women.svg"
                                                                            alt=""></span>
                                                                </div>
                                                            </div>
                                                            <div class="stu-id">
                                                    ...
                                                    <div class="head-right">
                                                        <div class="">
                                                            <span>
                                                                <span class="address">
                                                                    <img src="{{url('/')}}/assets/image/location.svg"
                                                                        alt=""> Gadwada
                                                                </span>
                                                            </span>
                                                            <br>
                                                            <span>
                                                                <span class="contact">
                                                                    <img src="{{url('/')}}/assets/image/call.svg"
                                                                        alt=""> 454545454
                                                                </span>
                                                            </span>
                                                        </div>
                                            ...
                                            <div class="fee-sec">
                                                <div class="fee-left">
                                                    <h6>Total Fees: <span
                                                            class="total-fee amounts"><label>₹</label></span></h6>
                                                </div>
                                                <div class="fee-right">
                                                    <h6>Due Fees: <span
                                                            class="due-fee remaining"><label>₹</label></span></h6>
                                                </div>
                                            </div>
                                            <div class="fee-list-head">
                                                <h6>Fees Summery</h6>
                                                <a href="javascript:void(0)" class="add-btn deposit-modal">Deposit
                                                    Fee</a>
                                            </div>
                                ...
                                <div class="min-height">
                                    ...
                                    <div class="deposit-form">
                                        ...
                                        <form action="JavaScript:void(0)" id="add-fees" method="post">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <input type="submit" name="save" class="add-btn align-center"
                                                    id="but-save" value="Add Fee">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="deposit-form">
                                        ...
                                        <form action="JavaScript:Void(0)" id="edit-fees" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group birth-date">
                                                        <input type="text" name="date" id="dates" value=""
                                                            placeholder="Date">
                                                        <span class="input-group-btn" for="date">
