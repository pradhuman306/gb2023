...
<div class="page-inner ad-inr">
    ...
    <section class="main-wrapper">
        <div class="page-color">
            ...
            <div class="page-header">
                <div class="page-title">
                    ...
                    <select class="cus-menu" name="select_session" id="select_session">
                        ...
                        <div class="page-btn">
                            <a href="{{route('feesstructure.create')}}" class="btn custom-btn addUser">Add Fees
                                Structure</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="page-body">
                <table id="example" class="custom-table" style="width:100%;">
                    <thead>
                        <tr>
                            <th>S.No.</th>
                            <th>Session</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            @endforeach
                            <td><label class="custom-badge  badge badge-primary">{{$test->amount}}</label></td>
                            <td>
                                <div class="d-flex">
                                    @if(Auth::check() && Auth::user()->user_type == "Admin")
                                    <span class="tool">
                                        <a data-toggle="tooltip" data-placement="top" data-original-title="Edit"
                                            class="btn-sml edit-btn" href="{{route('feesstructure.edit',$test->id)}}">
                                            <svg class="nofill" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="path-1-outside-1_1154_12363" maskUnits="userSpaceOnUse" x="3"
                                                    y="4" width="17" height="17" fill="black">
                                    ...
                                    <span class="tool">
                                        <a data-toggle="tooltip" data-placement="top" data-original-title="Delete"
                                            ...
                                            class="btn-sml delete-btn delete-confirm" data-id="{{$test->id}}"
                                            data-name="{{ $test->class_name }}"> <svg width="24" height="24"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#8F99B3" stroke-width="2" stroke-linecap="round"></path>
                                                <path
